...
def generate_coord():
    x = round(random.randrange(0, display_width - snake_block) / 10.0) * 10.0
    y = round(random.randrange(0, display_height - snake_block) / 10.0) * 10.0
    return (x,y)
